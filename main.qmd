...
`r rotating_text(c('<i class="fa-solid fa-envelope"></i> mattocci27@gmail.com', '<i class="fa-brands fa-twitter"></i> @mattocci', '<i class="fa-brands fa-github"></i> github.com/mattocci27/xxxx', '<i class="fa-solid fa-globe"></i> https://mattocci27.github.io/'))`
:::


<br><br>

::: {.absolute .top-0 .blue .w-100}
[`r rmarkdown::metadata$date`]{.blue .fl} [`r rmarkdown::metadata$host`]{.fr .blue}
:::
...
Masatoshi Katabuchi | katabuchi@xtbg.ac.cn | AFEC-X 2022::XTBG | 2022-11-9
...
```
```{r, echo=FALSE, fig.retina=3, fig.height=5}
...
<img src="images/sparks.png" width =80%>
...
::: columns
::: {.column width=50%}
![](./images/comp-hier1.jpg){width="350px"}
...
::: {.column width=50%}
![](./images/comp-hier2.jpg){width="350px"}
