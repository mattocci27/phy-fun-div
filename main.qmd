---
pagetitle: "Diversity and Trait-Based Approaches"
...
<img src="images/dip_traits.png" width="80%" style="display: block; margin: auto;"/>
...
<img src="images/traits2024.png" width =100% style="display: block; margin: auto;"/>
...
<img src="images/trait_plot.png" width =100% style="display: block; margin: auto;"/>

::: footer
[1]
Osnas, Katabuchi et al. Divergent drivers of leaf trait variation within species, among species, and among functional groups. PNAS 115:5480–5485 (2018).
:::


::: notes
There are opssite pettern between within-species and among-species relationships
:::
---

## Using harder-to-measure physiological traits may not be enough

<img src="images/pim.png" width =100% style="display: block; margin: auto;"/>
...
::: notes
- hard traits and vital rates are better but not enough

- Combining traits with demographic characteristics and model-based metrics can improve our ability to predict coexistence.
:::

---

## Decomposing LMA into metabolic (LMAm) and structural (LMAs) components improves physiological prediction{.small}

<img src="images/gl_point.png" width =120% style="display: block; margin: auto;"/>

PIMs (LMAm/LMAs) outperform bulk LMA for predicting physiology

::: footer
Katabuchi, M. et al. Decomposing leaf mass into metabolic and structural components explains divergent patterns of trait variation within and among plant species. Oecologia 207:71 (2025).
:::

::: notes
Decomposing LMA into metabolic and structural components improves prediction of photosynthesis, respiration, and lifespan—an instance of ‘process‑informed metrics’ bridging traits to performance.
:::
